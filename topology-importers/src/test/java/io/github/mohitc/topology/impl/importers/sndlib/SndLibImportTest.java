...
import io.github.mohitc.topology.impl.primitives.LinkImpl;
import io.github.mohitc.topology.impl.primitives.NetworkElementImpl;
import io.github.mohitc.topology.impl.primitives.TopologyManagerImpl;
...
public class SndLibImportTest {
  ...
  public void testImport(SNDLibSource source) {
    ...
    try {
      ...
      importer.importFromFile(Objects.requireNonNull(this.getClass().getClassLoader().getResource(source.fileName)).getFile(), manager);
