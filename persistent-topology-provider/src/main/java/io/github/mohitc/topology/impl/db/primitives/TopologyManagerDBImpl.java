...
public class TopologyManagerDBImpl implements TopologyManager {
  ...
  public void removeTopologyElement(int id) throws TopologyException {
    ...
    if (te != null) {
      ...
      log.error("Element not found in database");
      throw new TopologyException("Element not found in database");
    }
  }
  ...
  public void removeNetworkElement(int id) throws TopologyException {
    try (EntityManager em = getEntityManager()) {
      ...
      throw new TopologyException("Element with ID: " + id + " does not exist or is not an instance of NetworkElement", e);
    }
  }
  ...
  public void removeConnectionPoint(int id) throws TopologyException {
    try (EntityManager em = getEntityManager()) {
      ...
      if (Port.class.isAssignableFrom(cp.getClass())) {
        ...
        Port port = (Port) cp;
        if (!(port.getContainedConnectionPoints() == null || port.getContainedConnectionPoints().isEmpty())) {
      ...
      if (cp.getConnections() == null || cp.getConnections().isEmpty()) {
      ...
      throw new TopologyException("Element with ID: " + id + " does not exist or is not an instance of ConnectionPoint", e);
    }
  }
  ...
  public void removeLink(int id) throws TopologyException {
    ...
    try (EntityManager em = getEntityManager()) {
      ...
      throw new TopologyException("Element with ID: " + id + " does not exist or is not an instance of Link", e);
    }
  }
  ...
  public void removeCrossConnect(int id) throws TopologyException {
    ...
    try (EntityManager em = getEntityManager()) {
      ...
      throw new TopologyException("Element with ID: " + id + " does not exist or is not an instance of CrossConnect", e);
    }
  }
  ...
  public Set<Connection> getConnections(int startNeID, int endNeID) throws TopologyException {
    try (EntityManager em = getEntityManager()) {
      TypedQuery<ConnectionDBImpl> query = em.createNamedQuery(ConnectionDBImpl.GET_CONNECTIONS_BY_NES, ConnectionDBImpl.class);
  ...
  public Set<Connection> getConnections(int startNeID, int endNeID, NetworkLayer layer) throws TopologyException {
    ...
    try (EntityManager em = getEntityManager()) {
      TypedQuery<ConnectionDBImpl> query = em.createNamedQuery(ConnectionDBImpl.GET_CONNECTIONS_BY_NES_AND_LAYER, ConnectionDBImpl.class);
      query.setParameter("ne1", this.getElementByID(startNeID));
      query.setParameter("ne2", this.getElementByID(endNeID));
      query.setParameter("layer", layer);
      query.setParameter("instance", this.getIdentifier());
  ...
  public Set<Connection> getConnections(int startNeID, int endNeID, boolean isDirected) throws TopologyException {
    ...
    try (EntityManager em = getEntityManager()) {
      TypedQuery<ConnectionDBImpl> query = em.createNamedQuery(ConnectionDBImpl.GET_DIRECTED_CONNECTIONS_BY_NES, ConnectionDBImpl.class);
      query.setParameter("ne1", this.getElementByID(startNeID));
      query.setParameter("ne2", this.getElementByID(endNeID));
      query.setParameter("instance", this.getIdentifier());
      return query.getResultStream().collect(Collectors.toSet());
  ...
  public Set<Connection> getConnections(int startNeID, int endNeID, boolean isDirected, NetworkLayer layer) throws TopologyException {
    ...
    try (EntityManager em = getEntityManager()) {
      TypedQuery<ConnectionDBImpl> query = em.createNamedQuery(ConnectionDBImpl.GET_DIRECTED_CONNECTIONS_BY_NES_AND_LAYER, ConnectionDBImpl.class);
      query.setParameter("ne1", this.getElementByID(startNeID));
      query.setParameter("ne2", this.getElementByID(endNeID));
      query.setParameter("layer", layer);
      query.setParameter("instance", this.getIdentifier());
  ...
  public TEPropertyKey registerKey(String id, String desc, Class objectClass, Class<? extends PropertyConverter> converterClass) throws PropertyException {
    ...
    if (containsKey(id)) {
      //key already exists
      log.info("The key with ID {} is already registered in the PropertyFactory", id);
      return getKey(id);
    } else {
      ...
      try (EntityManager em = getEntityManager()) {
        ...
        em.persist(key);
        em.getTransaction().commit();
        log.debug("Key {} registered successfully", key);
        return key;
      }
    }
  }
  ...
  public TEPropertyKey getKey(String id) throws PropertyException {
    ...
    try (EntityManager em = getEntityManager()) {
      ...
      throw new PropertyException("Error while fetching key: " + id, e);
    }
  }
  ...
  public void addProperty(TEPropertyKey key, Object value) throws PropertyException {
    ...
    try(EntityManager em = EntityManagerFactoryHelper.getEntityManager()) {
      ...
      TEPropertyKeyDBImpl keyDB = (TEPropertyKeyDBImpl) getKey(key.id());
