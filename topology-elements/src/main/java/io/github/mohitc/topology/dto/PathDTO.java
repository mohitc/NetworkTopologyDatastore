...
public class PathDTO {
  ...
  private List<Integer> forwardConnectionSequence;

  private List<Integer> backwardConnectionSequence;

  private List<Integer> forwardConnectionPointSequence;

  private List<Integer> backwardConnectionPointSequence;
